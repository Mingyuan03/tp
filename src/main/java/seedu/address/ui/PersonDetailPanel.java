...
public class PersonDetailPanel {
    ...
    private VBox createContainer() {
        ...
        tagsContainer.setPrefWrapLength(350);  // Wider width before wrapping
        tagsContainer.setMinHeight(80);        // Give more vertical space
        tagsContainer.setHgap(8);              // Horizontal gap between tags
        tagsContainer.setVgap(10);             // Vertical gap between tag rows
