...
public class LogsCenter {
     ...
     * object. Applies to all loggers created
     * using {@link #getLogger(String)} and {@link #getLogger(Class)} methods except
     ...
     * name so that the created logger
     * becomes a descendant of the {@code baseLogger}. Furthermore, the returned
     * logger will have the same log handlers
    ...
    /**
     * Creates a logger named 'talentmatch', containing a {@code ConsoleHandler} and
     * a {@code FileHandler}.
     * Sets it as the {@code baseLogger}, to be used as the parent logger of all
     * other loggers.
     */
    private static void setBaseLogger() {
        baseLogger = Logger.getLogger("talentmatch");
