...
/**
 * Parses input arguments and creates a new {@code AdvanceApplicationCommand} object, enabling multiple dispatch by
    ...
    public AdvanceApplicationCommand parse(String args) throws ParseException {
        ...
        try {
            ...
            if (arePrefixesPresent(argMultimap, PREFIX_APPLICATION_INDEX)) {
                ...
                return new AdvanceApplicationCommand(jobIndex, appByJobIndex, true);
            } else {
                ...
                return new AdvanceApplicationCommand(jobIndex, personIndex, false);
            }
